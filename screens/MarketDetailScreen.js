...
class GetMarketDetail extends Component {
    constructor(props) {
        super(props);
...
const MarketDetailRouteStack = createStackNavigator(
    {
        MarketDetail: GetMarketDetail,
...
const MarketDetailContainer = createAppContainer(MarketDetailRouteStack);
